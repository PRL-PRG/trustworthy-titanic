...
The whole thing is fake since the names of the passangers are known, so it is simple lookup. Here we pretend that we dont have this information, and try to buid a predictive model using various methods.   
