...
original author: 'Megan L. Risdal'
secondary author: 'Michelle Santos'
date: '6 March 2016'
update: '23 Nov 2016'
updates: noted by MS
output:
...
MS: Would be interesting to look at whether or not having multiple females or males increases chances.
But I'm not sure how the records relate to each other - can we identify family units?
Also noticed a distirbution shift male/female with respect to family size.
