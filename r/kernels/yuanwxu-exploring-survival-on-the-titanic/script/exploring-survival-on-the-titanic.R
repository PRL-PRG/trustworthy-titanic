...
lr_model <- glm(Survived ~ Pclass + Sex + Age + SibSp + Parch + 
                                            Fare + Embarked + Title + 
                                            FsizeD + Child + Mother,
...
lr.pred <- ifelse(lr.probs>0.5, 1, 0) # Assign 1 if predicted probability of surviving is greater than 0.5, else assign 0.
