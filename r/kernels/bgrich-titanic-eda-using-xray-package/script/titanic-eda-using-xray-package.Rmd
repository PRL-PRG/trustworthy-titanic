---
title: "Titanic EDA Using 'xray' Package"
...
```{r xray_distributions, warning = FALSE, fig.width = 9}
training %>% 
...
*Note that the Age variable was removed due to poor interactions with the NA's 
present. The variables Ticket and Cabin were also removed due to the large 
numbers of categories present.*
