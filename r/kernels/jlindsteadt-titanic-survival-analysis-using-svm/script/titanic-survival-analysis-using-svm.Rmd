...
Above you can see we're missing 263 Age values and 1 Fare value.  
...
The above to plots show females were much more likely to survive than males.
...
If you were a single passenger or in a family larger than 4, you were less likely to survive than die.
...
3rd Class passengers much more likely to die than other classes.
...
We construct an SVM model using Age, Fare, Sex, Embarked, Fsize, Title, Pclass variables.  The train data set has an accuracy of .833895.  Below is the code submitted for the test data which yielded .78468.

In the future, I will test different methods on the same data to optimize the model.
