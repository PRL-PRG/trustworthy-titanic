...
# Load data
missing.types <- c("NA", "")
train.data <- read.csv("../input/train.csv", na.strings = missing.types, stringsAsFactors = F)
test.data  <- read.csv("../input/test.csv",  na.strings = missing.types, stringsAsFactors = F)
