...
To analyze and Understand the Disaster and the bias that occurred during rescue operations.
Also, using Machine learning we will predict the likely outcome of a person being saved or left for dead base on their socio-economic status.
...
This research is of 3 types
* Descriptive Analytics
* Diagnostic Analytics
* Predictive Analytics


The data is accquired from Kaggle release under the Open Data Commons Public Domain Dedication and License (PDDL).
...
Statistical Techniques used are Regression, Random Forest, Machine Learning Algorithms and Predications.
R Studio Tool with a set of highly functional packages are used in this Project to Data Manipulation, Data Cleaning, Visualization using GGPlot and Prediction.
...
We've taken care of splitting passenger name into some new variables, we can take it a step further and make some new family variables. First we're going to make a **family size** variable based on number of siblings/spouse(s) (maybe someone has more than one spouse?) and number of children/parents. 
...
We made our title variable! It has the highest relative importance out of all of our predictor variables. I think I'm most surprised to see that passenger class fell to `r rankImportance[rankImportance$Variable == 'Pclass', ]$Rank`, but maybe that's just bias coming from watching the movie Titanic too many times as a kid.
...
We Conformed our Hypothesis than a Persons Socio-Economic Status is related to his survival.
Through this Machine Learning Model, we Developed we can Predict the Survival of People in Future Incidents.
