...
Since many wonderful tutorials (both on Python and R) are available for Titanic challenge, 
it is a great exercise to practice for a beginner. This is how I come here. I would 
like to share my raw simple script and to learn from the community.
...
5. Prediction
---------------
Perform the prediction using above classifier and save the results in accordance with Kaggle requirement. The function `kagglePred` defined below predicts and save the result to files. 
```{r}
