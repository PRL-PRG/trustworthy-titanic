...
This is my first stab at the titanic dataset. I will be doing missing value imputations, exploratory analysis with illustrative visualisation, feature engineering and prediction using 'randomForest'.
...
We have a lot of missing values for Cabin, since we won't be needing it for our prediction we will drop it out of our dataset.
...
Here we build the model using random forest on our training data.
...
Voila! There you have it, my first Machine Learning Project. This has been an enjoyable experience, I'll be doing many more of these Kaggle projects in the future. Any feedback would be greatly appreciated!! 