...
Overall, the model performed pretty well and the accuracy is 92.7%. Furthermore, AUC (ROC) should also come in and to test the model performance.
In future, SVM could be another option to make model comparison
