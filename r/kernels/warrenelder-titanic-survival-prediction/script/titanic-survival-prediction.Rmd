...
Additional data has been created on passengers nationality, and is detailed in *Section 4.6*.
...
Now we re-plot the box-plot but with the FarePerPerson instead of the Fare.
...
- Employ ensemble learning and utilise the predictions from our different models.
...
I like to acknowledge the kernal, "Exploring Survival on the Titanic" by Megan Risdall, which provided a really good introduction to the data and Kaggle competitions.